...
dst = r'c:\Users\Eklavya Srivastava\Desktop\Hackathon\HackGrid-26\frontend\src\App.jsx'
...
# Hook into the "Accept term sheet" button (Buyer side)
...
# Hook into the "Accept buyer" button (Farmer side)
content = content.replace(
