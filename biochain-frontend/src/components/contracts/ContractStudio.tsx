      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-zinc-950 border border-amber-500/20 p-6 sm:p-8 rounded-2xl relative overflow-hidden shadow-2xl">
          ...
          <div className="flex items-center gap-3 z-10">
            <span className="px-3.5 py-1.5 rounded-full bg-zinc-900 border border-zinc-700 text-zinc-300 text-xs font-semibold flex items-center gap-1.5">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          {/* Configuration Form */}
          <div className="lg:col-span-5 bg-zinc-950 border border-zinc-800 rounded-2xl p-6 space-y-6 shadow-xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-zinc-900 border border-zinc-700 rounded-xl px-4 py-2.5 text-sm text-white focus:outline-none focus:border-amber-500 transition-colors"
                />
              </div>
              ...
              <div className="bg-zinc-900/80 p-4 rounded-xl border border-zinc-800 space-y-3">
                ...
                <div className="flex justify-between items-center text-xs">
                  <span className="text-zinc-400">Advance Escrow Lock</span>
                  <span className="font-bold text-white">{escrowAdvance}% (Pre-Dispatch)</span>
                </div>
                <input
                  type="range"
                  min="10"
                ...
                <div className="flex justify-between items-center text-xs pt-1">
                  <span className="text-zinc-400">Transit Spoilage Cap</span>
                  <span className="font-bold text-white">{spoilageCap}% Max</span>
                </div>
                <input
                  type="range"
                  min="1"
              ...
              {/* Valuation Card */}
              <div className="bg-gradient-to-br from-amber-500/10 to-yellow-600/5 p-4 rounded-xl border border-amber-500/30 flex justify-between items-center">
                <div>
          ...
          <div className="lg:col-span-7 space-y-4">
            <div className="bg-zinc-950 border border-zinc-800 rounded-2xl p-6 shadow-xl flex flex-col h-full min-h-[500px]">
              <div className="flex justify-between items-center border-b border-zinc-800 pb-4 mb-4">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="p-2 rounded-lg bg-zinc-900 border border-zinc-700 hover:border-amber-500 text-zinc-300 hover:text-white transition-colors disabled:opacity-30 cursor-pointer"
                    title="Copy Contract"
                  >
              ...
              <div className="flex-1 bg-black rounded-xl p-5 border border-zinc-900 font-mono text-xs text-amber-200/90 overflow-y-auto leading-relaxed shadow-inner">
                {contractResult ? (
                  ...
                  <div className="h-full flex flex-col items-center justify-center text-zinc-600 text-center space-y-3 py-16">
                    ...
                    <div>
                      <p className="font-semibold text-zinc-400 text-sm">Contract Ready for Drafting</p>
              ...
              {/* Cryptographic Seal */}
              {contractResult && (
                <div className="mt-4 pt-4 border-t border-zinc-800/80 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 text-[11px] text-zinc-400">
                  <div className="flex items-center gap-2">
                    <ShieldCheck className="w-4 h-4 text-emerald-400" />
                    <span>BioChain Escrow Hash: <code className="text-amber-400 font-mono">0x4a9b...7f21</code></span>
                  </div>
